...
class _CustomExpansionTileState extends State<CustomExpansionTile>
  ...
  void didChangeDependencies() {
    ...
    final bool? status = Provider.of<SearchProvider>(context).isExpanded;
    if (status != _isExpanded) {
      _handleTap();
    }
  ...
  Widget build(BuildContext context) {
    ...
    // final bool closed = !searchProvider.isExpanded! && _controller.isDismissed;
    ...
    return Consumer<SearchProvider>(
      builder: (context, searchProvider, _) => AnimatedBuilder(
